            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="blog-detail-ct">
                        ...
                        <img src="{{asset('assets/images/uploads/blog-detail.jpg')}}" alt="">
                        <p>
                        ...
                        <div class="flex-it flex-ct">
                            ...
                            <img src="{{asset('assets/images/uploads/blog-detail2.jpg')}}" alt="">
                        </div>
                        ...
                        <div class="comments">
                            ...
                            <div class="cmt-item flex-it">
                                <img src="{{asset('assets/images/uploads/author.png')}}" alt="">
                            ...
                            <div class="cmt-item flex-it reply">
                                <img src="{{asset('assets/images/uploads/author2.png')}}" alt="">
                                <div class="author-infor">
                                    <div class="flex-it2">
                            ...
                            <div class="cmt-item flex-it reply">
                                <img src="{{asset('assets/images/uploads/author3.png')}}" alt="">
                                <div class="author-infor">
                                    <div class="flex-it2">
                            ...
                            <div class="cmt-item flex-it">
                                <img src="{{asset('assets/images/uploads/author4.png')}}" alt="">
                                <div class="author-infor">
                                    <div class="flex-it2">
