            ...
            <div class="row">
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it1.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">Godzilla: King Of The Monsters Adds O’Shea Jackson Jr</a></h3>
                    ...
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it2.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">Magnolia Nabs ‘Lucky’ Starring Harry Dean Stanton</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it3.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">‘Going in Style’ Tops ‘Smurfs: The Lost Village’ at Thursday Box Office</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it4.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">India’s National Film Awards: ‘Kaasav’ Wins Best Picture</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it5.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">‘Kong: Skull Island’ Tops $500 Million at Worldwide Box Office</a></h3>
                            <span class="time">27 Mar 2017</span>
                    ...
                    <div class="blog-item-style-1 blog-item-style-3">
                        <img src="{{asset('assets/images/uploads/bloglist-it6.jpg')}}" alt="">
                        <div class="blog-it-infor">
                            <h3><a href="{{URL::Route('blog_detail')}}">Film Review: ‘Aftermath’</a></h3>
                            <span class="time">27 Mar 2017</span>
