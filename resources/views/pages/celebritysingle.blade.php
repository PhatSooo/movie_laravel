        ...
        <div class="container">
            <div class="row ipad-width">
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <div class="mv-ceb">
                        <img src="{{asset('assets/images/uploads/cebsingle2.png')}}" alt="">
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                ...
                                                <div class="mvsingle-item ov-item">
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image11.jpg')}}" ><img src="{{asset('assets/images/uploads/image1.jpg')}}" alt=""></a>
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image21.jpg')}}" ><img src="{{asset('assets/images/uploads/image2.jpg')}}" alt=""></a>
                                                    <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image31.jpg')}}" ><img src="{{asset('assets/images/uploads/image3.jpg')}}" alt=""></a>
                                                    <div class="vd-it">
                                                        <img class="vd-img" src="{{asset('assets/images/uploads/image4.jpg')}}" alt="">
                                                        <a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{asset('assets/images/uploads/play-vd.png')}}" alt=""></a>
                                                    </div>
                                                </div>
                                                <div class="title-hd-sm">
                                                    <h4>filmography</h4>
                                                ...
                                                <div class="mvcast-item">
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film1.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film2.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film3.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film4.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film5.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film6.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film7.jpg')}}" alt="">
                                                            <div>
                                                    ...
                                                    <div class="cast-it">
                                                        <div class="cast-left cebleb-film">
                                                            <img src="{{asset('assets/images/uploads/film8.jpg')}}" alt="">
                                                            <div>
                                    ...
                                    <div id="mediaceb" class="tab">
                                        <div class="row">
                                            ...
                                            <div class="mvsingle-item media-item">
                                                <div class="vd-item">
                                                    <div class="vd-it">
                                                        <img class="vd-img" src="{{asset('assets/images/uploads/vd-item1.jpg')}}" alt="">
                                                        <a class="fancybox-media hvr-grow"  href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{asset('assets/images/uploads/play-vd.png')}}" alt=""></a>
                                                    </div>
                                                    <div class="vd-infor">
                                                ...
                                                <div class="vd-item">
                                                    <div class="vd-it">
                                                        <img class="vd-img" src="{{asset('assets/images/uploads/vd-item2.jpg')}}" alt="">
                                                        <a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{asset('assets/images/uploads/play-vd.png')}}" alt=""></a>
                                                    </div>
                                                    <div class="vd-infor">
                                                ...
                                                <div class="vd-item">
                                                    <div class="vd-it">
                                                        <img class="vd-img" src="{{asset('assets/images/uploads/vd-item3.jpg')}}" alt="">
                                                        <a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{asset('assets/images/uploads/play-vd.png')}}" alt=""></a>
                                                    </div>
                                                    <div class="vd-infor">
                                                ...
                                                <div class="vd-item">
                                                    <div class="vd-it">
                                                        <img class="vd-img" src="{{asset('assets/images/uploads/vd-item4.jpg')}}" alt="">
                                                        <a class="fancybox-media hvr-grow" href="https://www.youtube.com/embed/o-0hcF97wy0"><img src="{{asset('assets/images/uploads/play-vd.png')}}" alt=""></a>
                                                    </div>
                                                    <div class="vd-infor">
                                            ...
                                            <div class="mvsingle-item">
                                                ...
                                                <a class="img-lightbox"  data-fancybox-group="gallery"  href="{{asset('assets/images/uploads/image21.jpg')}}" ><img src="{{asset('assets/images/uploads/image2.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image31.jpg')}}" ><img src="{{asset('assets/images/uploads/image3.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image41.jpg')}}" ><img src="{{asset('assets/images/uploads/image4.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image51.jpg')}}" ><img src="{{asset('assets/images/uploads/image5.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image61.jpg')}}" ><img src="{{asset('assets/images/uploads/image6.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image71.jpg')}}" ><img src="{{asset('assets/images/uploads/image7.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image81.jpg')}}" ><img src="{{asset('assets/images/uploads/image8.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image91.jpg')}}" ><img src="{{asset('assets/images/uploads/image9.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image101.jpg')}}" ><img src="{{asset('assets/images/uploads/image10.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image111.jpg')}}" ><img src="{{asset('assets/images/uploads/image1-1.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image121.jpg')}}" ><img src="{{asset('assets/images/uploads/image12.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image131.jpg')}}" ><img src="{{asset('assets/images/uploads/image13.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image141.jpg')}}" ><img src="{{asset('assets/images/uploads/image14.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image151.jpg')}}" ><img src="{{asset('assets/images/uploads/image15.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image161.jpg')}}" ><img src="{{asset('assets/images/uploads/image16.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image171.jpg')}}" ><img src="{{asset('assets/images/uploads/image17.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image181.jpg')}}" ><img src="{{asset('assets/images/uploads/image18.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image191.jpg')}}" ><img src="{{asset('assets/images/uploads/image19.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image201.jpg')}}" ><img src="{{asset('assets/images/uploads/image20.jpg')}}" alt=""></a>
                                                <a class="img-lightbox"  data-fancybox-group="gallery" href="{{asset('assets/images/uploads/image211.jpg')}}" ><img src="{{asset('assets/images/uploads/image2-1.jpg')}}" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
